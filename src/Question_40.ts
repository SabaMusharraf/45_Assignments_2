...
function make_album(artist_name:string, album_track:string, tracks?:number){
    ...
    let music_album1 = make_album ("Hadiqa Kiani", "Rung");
    let music_album2 = make_album ("Amanat Ali", "Kohram");
    let music_album3 = make_album ("Atif Aslam", "Doori", 30);    
